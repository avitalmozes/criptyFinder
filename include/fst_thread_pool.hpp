...
{
public:
    explicit FstThreadPool(unsigned int numThreads, const std::string& pool_name = "tp");

    // No copy
    FstThreadPool(const FstThreadPool&) = delete;
    FstThreadPool& operator=(const FstThreadPool&) = delete;
